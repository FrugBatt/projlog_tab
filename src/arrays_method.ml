...
let rec leaf_append_two tree tapp1 tapp2 =
  ...
  | Node (form, b, t1, t2) ->
      Node
        (form, b, leaf_append_two t1 tapp1 tapp2, leaf_append_two t2 tapp1 tapp2)
